                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="card card-primary card-outline">
                                                                ...
                                                                <div class="card-body" style="display: block;">
                                                                    ...
                                                                    <a href="/admin/me/auditorWorkingRes/{{$d->id}}/success" class="card-link">通过</a>
                                                                    <a href="/admin/me/auditorWorkingRes/{{$d->id}}/fail" class="card-link">不通过</a>
                                                                </div>
                                                            </div><!-- /.card -->
                                                        </div>
                                                    </div>
