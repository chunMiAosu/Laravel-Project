...
<!-- Site wrapper -->
    ...
    <script>
        $(function(){
            ...
            tmp = document.getElementById("a_finance").className;
            document.getElementById("a_finance").setAttribute("class",tmp+" active");

            $(".btn").on('click',function (event) {
                let uid = this.id;
                $.ajax({
                    url : '/admin/article/finance/delete',
                    type : 'get',
                    data : 'id='+uid,
                    dataType : 'json',
