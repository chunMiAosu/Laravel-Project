...
<!-- Site wrapper -->
    ...
    <script>
        $(function(){
            ...
            tmp = document.getElementById("a_military").className;
            document.getElementById("a_military").setAttribute("class",tmp+" active");

            $(".btn").on('click',function (event) {
                let uid = this.id;
                $.ajax({
                    url : '/admin/article/military/delete',
                    type : 'get',
                    data : 'id='+uid,
                    dataType : 'json',
